...
class Game():
    def __init__(self):
        ...
        self.brown = pygame.Color(160, 40 , 40)
        self.green = pygame.Color(0, 255, 0)
    ...
    def game_over(self):
        go_font = pygame.font.SysFont('monaco', 90)
        go_surf = go_font.render('Game Over', True, self.red)
        go_rect = go_surf.get_rect()
        go_rect.midtop = (320, 20)
...
class Snake():
    def __init__(self, snake_color):
        self.snake_head_pos = [90, 50]
        self.snake_body = [[190, 50], [80, 50], [70, 50]]
